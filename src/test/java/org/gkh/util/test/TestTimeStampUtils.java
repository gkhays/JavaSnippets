package org.gkh.util.test;

import static org.junit.Assert.*;

import java.util.Date;

import org.gkh.util.TimeUtils;
...
public class TestTimeStampUtils {
	...
	public void testISO8609ForCurrent() {
		Date now = new Date();
		String timeStamp = TimeUtils.dateToISO8601String();
	...
	public void testISO8609ToUnixTime() {
		...
		for (String timeStamp : loginTimes) {
			unixtime = TimeUtils.iso8601StringToUnixTime(timeStamp);
